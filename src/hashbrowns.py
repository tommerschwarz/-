...
if __name__ == "__main__":
    input_folder = '../../../data/hw2grad_M_1/' # folder with all the data
    reads_fn = join(input_folder, '') # need to change to reads file after finding exact matches from BWA aligner
    ref_fn = join(input_folder, 'ref_chr_1.txt') # which chromosome to be looking at (1-4)
    key_length = 7
    start = time.clock()
    ...
    ### OUTPUT DIFFERENTLY ###
    # this part is not edited yet, not sure how we want to output the aligned reads
